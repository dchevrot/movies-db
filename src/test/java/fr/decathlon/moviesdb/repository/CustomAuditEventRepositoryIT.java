...
import fr.decathlon.moviesdb.config.audit.AuditEventConverter;
import fr.decathlon.moviesdb.domain.PersistentAuditEvent;
...
import static fr.decathlon.moviesdb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
